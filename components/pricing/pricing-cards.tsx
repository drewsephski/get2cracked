...
function CheckoutButton({ year, offer }: CheckoutButtonProps) {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (!priceId) {
        console.error("No price ID found for this plan");
        return;
      }
      ...
      >
        ...
        <div className="flex h-full flex-col justify-between gap-16 p-6">
          ...
          {userId && subscriptionPlan ? (
            ...
            <CheckoutButton year={isYearly} offer={offer} />
          )}
        </div>
      </div>
    );
