...
```bash
npx create-next-app my-saas-project --example "https://github.com/drewsephski/next-saas-stripe-starter"
```

Or deploy with Vercel :

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fdrewsephski%2Fnext-saas-stripe-starter)
